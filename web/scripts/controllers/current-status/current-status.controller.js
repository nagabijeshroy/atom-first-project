...
CurrentStatusController.$inject = ['$scope', 'CurrentStatusService', '$uibModal', '$log', '$document'];

function CurrentStatusController($scope, CurrentStatusService, $uibModal, $log, $document) {
    var vm = this;
    vm.status = {
        isEmpty: false
    }
