...
AchievementsController.$inject = ['$scope', 'AchievementsService', '$uibModal', '$log', '$document'];

function AchievementsController($scope, AchievementsService, $uibModal, $log, $document) {
    var vm = this;
    vm.status = {
        isCollapsed: false,
        isEmpty: false
